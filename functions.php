...
global $stripe;
$stripe_key='sk_test_51H32P5JtDALqulAj1po9o8Qa1RPphCcS4dxx0ZOuz4nAek5yS3wDWzMVxtX0qSvdXkpyfaf3Qqp1O4LRwqDiXuI000uogvLPdk';
...
function create_stripe_customer( $user_id ) {
	...
	try{
		...
		update_user_meta($user_id,'stripe_customer_id',$data->id);
	}
	catch(Exception $e){
